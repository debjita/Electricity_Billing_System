...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer(){
        ...
        p.setBackground(new Color(236, 235, 233));
        ...
        /*ImageIcon ic1 = new ImageIcon(ClassLoader.getSystemResource("icon/new_customer.png"));
        Image i3 = ic1.getImage().getScaledInstance(80, 80,Image.SCALE_DEFAULT);
