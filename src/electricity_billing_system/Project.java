...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        this.meter = meter;
        //setBounds(-10,0,1920,1030);
        setExtendedState(JFrame.MAXIMIZED_BOTH); 
        //setSize( 1650,1080);
        
        /* Adding background image */
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon\\background.jpg"));
        ...
        //mb.setLayout(new GridLayout(5,5));
        //mb.add(Box.createRigidArea(new Dimension(500,250)));
        
        Font f = new FontUIResource(mb.getFont().getFontName(), mb.getFont().getStyle(), 12);
        UIManager.put("Menu.font", f);
         SwingUtilities.updateComponentTreeUI(mb);
         
  
        JMenu master = new JMenu("Manage");
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/customer_details.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icon/meter_details.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/deposit_details.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon\\calculate_bill.png"));
        ...
        ImageIcon icon41 = new ImageIcon(ClassLoader.getSystemResource("icon/update.png"));
        ...
        ImageIcon icon42 = new ImageIcon(ClassLoader.getSystemResource("icon/view.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icon/pay.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/bill_details.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/bill.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/browser.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("icon/logout.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\Users\\Public\\Desktop\\Google Chrome.lnk");
            }catch(Exception e){ }
